...
def plot_viability_pointplots(viability_genes):
    """
    Plot normalized viability measurements across growth format and media conditions in validation experiments

    Args:
        viability_genes (list[str]): A list of genes to highlight
    """
    # load data and reformat conditions into a specific order
    ...
    # consolidate viability measurements per gene
...
def main():
    """
    Generate plot showing viability measurements for experimental validation of growth format and serum shifts
    """
    # figure 5h
